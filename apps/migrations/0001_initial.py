    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('operator', 'Operator'), ('manager', 'Manager'), ('admin', 'Admin'), ('kuryer', 'Kuryer'), ('foydalanuvchi', 'Foydalanuvchi')], db_default='foydalanuvchi', max_length=20)),
